...
```
    ...
    la lista, (ii) insertar un estudiante al inicio de la lista, (iii) verificar el carnet de un estudiante en una posición dada, (iv) eliminar de la lista a un estudiante en una
